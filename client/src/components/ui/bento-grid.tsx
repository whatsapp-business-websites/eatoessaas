...
const BentoGrid = ({
  ...
  return (
    <div
      className={cn(
        "grid w-full auto-rows-[16rem] grid-cols-3 gap-4", // Reduced from 22rem to 16rem
        className,
      )}
    >
      {children}
    ...
    {image && (
      <div className="absolute inset-0 z-0">
        <img
          src={image}
          alt={name}
          className="h-full w-full object-cover opacity-50 transition-opacity group-hover:opacity-60"
        />
