...
var Slot2 = React12.forwardRef((props, forwardedRef) => {
  ...
  if (slottable) {
    ...
    return (0, import_jsx_runtime10.jsx)(SlotClone2, { ...slotProps, ref: forwardedRef, children: React12.isValidElement(newElement) ? React12.cloneElement(newElement, void 0, newChildren) : null });
  }
  return (0, import_jsx_runtime10.jsx)(SlotClone2, { ...slotProps, ref: forwardedRef, children });
});
